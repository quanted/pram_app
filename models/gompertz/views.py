...
algorithm = '' \
            ...
            '<img src = \"/pram/static/images/latex/gompertz/gompertz_1.png\" alt=\"Gompertz_1\">'
...
description = '<p>The Gompertz model was first introduced to model mortality by'\
              ...
              '<img src = \"/pram/static/images/latex/gompertz/gompertz_des_1.png\" alt=\"Gompertz Model\">'\
