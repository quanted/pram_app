...
class TrexInp(forms.Form):
   ...
   #Application_type = forms.MultipleChoiceField(required=True, choices=Applicationtype_CHOICES, widget=forms.CheckboxSelectMultiple)
    ...
    seed_treatment_formulation_name = forms.CharField(max_length=255, label='Seed treatment formulation name', widget=forms.Textarea (attrs={'cols': 20, 'rows': 2}),initial='NA')    
