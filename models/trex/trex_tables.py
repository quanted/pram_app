...
import trex_model,trex_parameters
...
def gett1data_broad(trex_obj):
    data = { 
        ...
        "Value": ['%s' % trex_obj.chem_name, '%s' % trex_obj.use, '%s' % trex_obj.formu_name, '%s' % trex_obj.a_i_t1, '%s' % trex_obj.Application_type, 
                  '%s' % trex_obj.p_i, '%s' % trex_obj.h_l,],
        "Units": ['', '', '', '%', '', '%', 'days',],
    }
    return data
...
def gett1data_band(trex_obj):
    data = { 
        ...
        "Value": ['%s' % trex_obj.chem_name, '%s' % trex_obj.use, '%s' % trex_obj.formu_name, '%s' % trex_obj.a_i_t1, '%s' % trex_obj.Application_type, 
                  '%.4s' % trex_obj.r_s, '%.4s' % trex_obj.b_w_t1, '%s' % trex_obj.p_i, '%s' % trex_obj.h_l,],
...
def gett1data_seed(trex_obj):
    data = { 
        ...
        "Value": ['%s' % trex_obj.chem_name, '%s' % trex_obj.use, '%s' % trex_obj.formu_name, '%s' % trex_obj.a_i_t1, '%s' % trex_obj.Application_type, 
                  '%s' % trex_obj.seed_treatment_formulation_name, '%s' % trex_obj.seed_crop_v, '%s' % trex_obj.den, '%s' % trex_obj.m_s_r_p,],
...
def gett3data(trex_obj):
    data = { 
        ...
        "Value": ['%s' % trex_obj.ld50_bird, '%s' % trex_obj.Species_of_the_tested_bird_avian_ld50, '%s' % trex_obj.tw_bird_ld50,
                  '%s' % trex_obj.lc50_bird, '%s' % trex_obj.Species_of_the_tested_bird_avian_lc50, '%s' % trex_obj.tw_bird_lc50,
                  '%s' % trex_obj.NOAEC_bird, '%s' % trex_obj.Species_of_the_tested_bird_avian_NOAEC, '%s' % trex_obj.tw_bird_NOAEC,
                  '%s' % trex_obj.NOAEL_bird, '%s' % trex_obj.Species_of_the_tested_bird_avian_NOAEL, '%s' % trex_obj.tw_bird_NOAEL,
                  '%s' % trex_obj.aw_bird_sm, '%s' % trex_obj.aw_bird_md, '%s' % trex_obj.aw_bird_lg, '%s' % trex_obj.x, ],
...
def table_2(trex_obj):
        ...
        #table 2
        t2data_all=[]
        for i in range(int(trex_obj.n_a)):
            rate_temp=trex_obj.ar_lb[i]
            day_temp=trex_obj.day_out[i]
...
def table_5(trex_obj):
        ...
        #table 5
        sa_bird_1_s=trex_obj.sa_bird_1_s
        sa_bird_2_s=trex_obj.sa_bird_2_s
        sc_bird_s=trex_obj.sc_bird_s
        sa_mamm_1_s=trex_obj.sa_mamm_1_s
        sa_mamm_2_s=trex_obj.sa_mamm_2_s
        sc_mamm_s=trex_obj.sc_mamm_s
        
        sa_bird_1_m=trex_obj.sa_bird_1_m
        sa_bird_2_m=trex_obj.sa_bird_2_m
        sc_bird_m=trex_obj.sc_bird_m
        sa_mamm_1_m=trex_obj.sa_mamm_1_m
        sa_mamm_2_m=trex_obj.sa_mamm_2_m
        sc_mamm_m=trex_obj.sc_mamm_m
             
        sa_bird_1_l=trex_obj.sa_bird_1_l
        sa_bird_2_l=trex_obj.sa_bird_2_l
        sc_bird_l=trex_obj.sc_bird_l
        sa_mamm_1_l=trex_obj.sa_mamm_1_l
        sa_mamm_2_l=trex_obj.sa_mamm_2_l
        sc_mamm_l=trex_obj.sc_mamm_l
...
def table_6(trex_obj):
        ...
        """%(trex_obj.Application_type)
        #table 6
        EEC_diet_SG=trex_obj.EEC_diet_SG
        EEC_diet_TG=trex_obj.EEC_diet_TG
        EEC_diet_BP=trex_obj.EEC_diet_BP
        EEC_diet_FR=trex_obj.EEC_diet_FR
        EEC_diet_AR=trex_obj.EEC_diet_AR
...
def table_7(trex_obj):
        ...
        """
        #table 7
        EEC_dose_bird_SG_sm=trex_obj.EEC_dose_bird_SG_sm
        EEC_dose_bird_SG_md=trex_obj.EEC_dose_bird_SG_md
        EEC_dose_bird_SG_lg=trex_obj.EEC_dose_bird_SG_lg
        EEC_dose_bird_TG_sm=trex_obj.EEC_dose_bird_TG_sm
        EEC_dose_bird_TG_md=trex_obj.EEC_dose_bird_TG_md
        EEC_dose_bird_TG_lg=trex_obj.EEC_dose_bird_TG_lg
        EEC_dose_bird_BP_sm=trex_obj.EEC_dose_bird_BP_sm
        EEC_dose_bird_BP_md=trex_obj.EEC_dose_bird_BP_md
        EEC_dose_bird_BP_lg=trex_obj.EEC_dose_bird_BP_lg
        EEC_dose_bird_FP_sm=trex_obj.EEC_dose_bird_FP_sm
        EEC_dose_bird_FP_md=trex_obj.EEC_dose_bird_FP_md
        EEC_dose_bird_FP_lg=trex_obj.EEC_dose_bird_FP_lg
        EEC_dose_bird_AR_sm=trex_obj.EEC_dose_bird_AR_sm
        EEC_dose_bird_AR_md=trex_obj.EEC_dose_bird_AR_md
        EEC_dose_bird_AR_lg=trex_obj.EEC_dose_bird_AR_lg
        EEC_dose_bird_SE_sm=trex_obj.EEC_dose_bird_SE_sm
        EEC_dose_bird_SE_md=trex_obj.EEC_dose_bird_SE_md
        EEC_dose_bird_SE_lg=trex_obj.EEC_dose_bird_SE_lg
...
def table_7_add(trex_obj):
        ...
        """
        #table 7_add
        ARQ_bird_SG_sm=trex_obj.ARQ_bird_SG_sm
        ARQ_bird_SG_md=trex_obj.ARQ_bird_SG_md
        ARQ_bird_SG_lg=trex_obj.ARQ_bird_SG_lg
        ARQ_bird_TG_sm=trex_obj.ARQ_bird_TG_sm
        ARQ_bird_TG_md=trex_obj.ARQ_bird_TG_md
        ARQ_bird_TG_lg=trex_obj.ARQ_bird_TG_lg
        ARQ_bird_BP_sm=trex_obj.ARQ_bird_BP_sm
        ARQ_bird_BP_md=trex_obj.ARQ_bird_BP_md
        ARQ_bird_BP_lg=trex_obj.ARQ_bird_BP_lg
        ARQ_bird_FP_sm=trex_obj.ARQ_bird_FP_sm
        ARQ_bird_FP_md=trex_obj.ARQ_bird_FP_md
        ARQ_bird_FP_lg=trex_obj.ARQ_bird_FP_lg
        ARQ_bird_AR_sm=trex_obj.ARQ_bird_AR_sm
        ARQ_bird_AR_md=trex_obj.ARQ_bird_AR_md
        ARQ_bird_AR_lg=trex_obj.ARQ_bird_AR_lg
        ARQ_bird_SE_sm=trex_obj.ARQ_bird_SE_sm
        ARQ_bird_SE_md=trex_obj.ARQ_bird_SE_md
        ARQ_bird_SE_lg=trex_obj.ARQ_bird_SE_lg
...
def table_8(trex_obj):
        ...
        """
        #table 8
        ARQ_diet_bird_SG_A=trex_obj.ARQ_diet_bird_SG_A
        ARQ_diet_bird_SG_C=trex_obj.ARQ_diet_bird_SG_C
        ARQ_diet_bird_TG_A=trex_obj.ARQ_diet_bird_TG_A
        ARQ_diet_bird_TG_C=trex_obj.ARQ_diet_bird_TG_C
        ARQ_diet_bird_BP_A=trex_obj.ARQ_diet_bird_BP_A
        ARQ_diet_bird_BP_C=trex_obj.ARQ_diet_bird_BP_C
        ARQ_diet_bird_FP_A=trex_obj.ARQ_diet_bird_FP_A
        ARQ_diet_bird_FP_C=trex_obj.ARQ_diet_bird_FP_C
        ARQ_diet_bird_AR_A=trex_obj.ARQ_diet_bird_AR_A
        ARQ_diet_bird_AR_C=trex_obj.ARQ_diet_bird_AR_C
...
def table_9(trex_obj):
        ...
        """
        #table 9
        EEC_dose_mamm_SG_sm=trex_obj.EEC_dose_mamm_SG_sm
        EEC_dose_mamm_SG_md=trex_obj.EEC_dose_mamm_SG_md
        EEC_dose_mamm_SG_lg=trex_obj.EEC_dose_mamm_SG_lg
        EEC_dose_mamm_TG_sm=trex_obj.EEC_dose_mamm_TG_sm
        EEC_dose_mamm_TG_md=trex_obj.EEC_dose_mamm_TG_md
        EEC_dose_mamm_TG_lg=trex_obj.EEC_dose_mamm_TG_lg
        EEC_dose_mamm_BP_sm=trex_obj.EEC_dose_mamm_BP_sm
        EEC_dose_mamm_BP_md=trex_obj.EEC_dose_mamm_BP_md
        EEC_dose_mamm_BP_lg=trex_obj.EEC_dose_mamm_BP_lg
        EEC_dose_mamm_FP_sm=trex_obj.EEC_dose_mamm_FP_sm
        EEC_dose_mamm_FP_md=trex_obj.EEC_dose_mamm_FP_md
        EEC_dose_mamm_FP_lg=trex_obj.EEC_dose_mamm_FP_lg
        EEC_dose_mamm_AR_sm=trex_obj.EEC_dose_mamm_AR_sm
        EEC_dose_mamm_AR_md=trex_obj.EEC_dose_mamm_AR_md
        EEC_dose_mamm_AR_lg=trex_obj.EEC_dose_mamm_AR_lg
        EEC_dose_mamm_SE_sm=trex_obj.EEC_dose_mamm_SE_sm
        EEC_dose_mamm_SE_md=trex_obj.EEC_dose_mamm_SE_md
        EEC_dose_mamm_SE_lg=trex_obj.EEC_dose_mamm_SE_lg
...
def table_10(trex_obj):
        ...
        """
        #table 10
        ARQ_dose_mamm_SG_sm=trex_obj.ARQ_dose_mamm_SG_sm
        CRQ_dose_mamm_SG_sm=trex_obj.CRQ_dose_mamm_SG_sm
        ARQ_dose_mamm_SG_md=trex_obj.ARQ_dose_mamm_SG_md
        CRQ_dose_mamm_SG_md=trex_obj.CRQ_dose_mamm_SG_md
        ARQ_dose_mamm_SG_lg=trex_obj.ARQ_dose_mamm_SG_lg
        CRQ_dose_mamm_SG_lg=trex_obj.CRQ_dose_mamm_SG_lg
        
        ARQ_dose_mamm_TG_sm=trex_obj.ARQ_dose_mamm_TG_sm
        CRQ_dose_mamm_TG_sm=trex_obj.CRQ_dose_mamm_TG_sm
        ARQ_dose_mamm_TG_md=trex_obj.ARQ_dose_mamm_TG_md
        CRQ_dose_mamm_TG_md=trex_obj.CRQ_dose_mamm_TG_md
        ARQ_dose_mamm_TG_lg=trex_obj.ARQ_dose_mamm_TG_lg
        CRQ_dose_mamm_TG_lg=trex_obj.CRQ_dose_mamm_TG_lg
        
        ARQ_dose_mamm_BP_sm=trex_obj.ARQ_dose_mamm_BP_sm
        CRQ_dose_mamm_BP_sm=trex_obj.CRQ_dose_mamm_BP_sm
        ARQ_dose_mamm_BP_md=trex_obj.ARQ_dose_mamm_BP_md
        CRQ_dose_mamm_BP_md=trex_obj.CRQ_dose_mamm_BP_md
        ARQ_dose_mamm_BP_lg=trex_obj.ARQ_dose_mamm_BP_lg
        CRQ_dose_mamm_BP_lg=trex_obj.CRQ_dose_mamm_BP_lg
        
        ARQ_dose_mamm_FP_sm=trex_obj.ARQ_dose_mamm_FP_sm
        CRQ_dose_mamm_FP_sm=trex_obj.CRQ_dose_mamm_FP_sm
        ARQ_dose_mamm_FP_md=trex_obj.ARQ_dose_mamm_FP_md
        CRQ_dose_mamm_FP_md=trex_obj.CRQ_dose_mamm_FP_md
        ARQ_dose_mamm_FP_lg=trex_obj.ARQ_dose_mamm_FP_lg
        CRQ_dose_mamm_FP_lg=trex_obj.CRQ_dose_mamm_FP_lg
        
        ARQ_dose_mamm_AR_sm=trex_obj.ARQ_dose_mamm_AR_sm
        CRQ_dose_mamm_AR_sm=trex_obj.CRQ_dose_mamm_AR_sm
        ARQ_dose_mamm_AR_md=trex_obj.ARQ_dose_mamm_AR_md
        CRQ_dose_mamm_AR_md=trex_obj.CRQ_dose_mamm_AR_md
        ARQ_dose_mamm_AR_lg=trex_obj.ARQ_dose_mamm_AR_lg
        CRQ_dose_mamm_AR_lg=trex_obj.CRQ_dose_mamm_AR_lg
        
        ARQ_dose_mamm_SE_sm=trex_obj.ARQ_dose_mamm_SE_sm
        CRQ_dose_mamm_SE_sm=trex_obj.CRQ_dose_mamm_SE_sm
        ARQ_dose_mamm_SE_md=trex_obj.ARQ_dose_mamm_SE_md
        CRQ_dose_mamm_SE_md=trex_obj.CRQ_dose_mamm_SE_md
        ARQ_dose_mamm_SE_lg=trex_obj.ARQ_dose_mamm_SE_lg
        CRQ_dose_mamm_SE_lg=trex_obj.CRQ_dose_mamm_SE_lg
...
def table_11(trex_obj):
        ...
        """
        #table 11
        ARQ_diet_mamm_SG=trex_obj.ARQ_diet_mamm_SG
        CRQ_diet_mamm_SG=trex_obj.CRQ_diet_mamm_SG
        ARQ_diet_mamm_TG=trex_obj.ARQ_diet_mamm_TG
        CRQ_diet_mamm_TG=trex_obj.CRQ_diet_mamm_TG
        ARQ_diet_mamm_BP=trex_obj.ARQ_diet_mamm_BP
        CRQ_diet_mamm_BP=trex_obj.CRQ_diet_mamm_BP
        ARQ_diet_mamm_FP=trex_obj.ARQ_diet_mamm_FP
        CRQ_diet_mamm_FP=trex_obj.CRQ_diet_mamm_FP
        ARQ_diet_mamm_AR=trex_obj.ARQ_diet_mamm_AR
        CRQ_diet_mamm_AR=trex_obj.CRQ_diet_mamm_AR
...
def table_12(trex_obj):
        ...
        """
        #table 12
        LD50_rg_bird_sm=trex_obj.LD50_rg_bird_sm
        LD50_rg_mamm_sm=trex_obj.LD50_rg_mamm_sm
        LD50_rg_bird_md=trex_obj.LD50_rg_bird_md
        LD50_rg_mamm_md=trex_obj.LD50_rg_mamm_md
        LD50_rg_bird_lg=trex_obj.LD50_rg_bird_lg
        LD50_rg_mamm_lg=trex_obj.LD50_rg_mamm_lg
...
def table_13(trex_obj):
        ...
        """
        #table 13
        LD50_rl_bird_sm=trex_obj.LD50_rl_bird_sm
        LD50_rl_mamm_sm=trex_obj.LD50_rl_mamm_sm
        LD50_rl_bird_md=trex_obj.LD50_rl_bird_md
        LD50_rl_mamm_md=trex_obj.LD50_rl_mamm_md
        LD50_rl_bird_lg=trex_obj.LD50_rl_bird_lg
        LD50_rl_mamm_lg=trex_obj.LD50_rl_mamm_lg
...
def table_14(trex_obj):
        ...
        """
        #table 14
        LD50_bg_bird_sm=trex_obj.LD50_bg_bird_sm
        LD50_bg_mamm_sm=trex_obj.LD50_bg_mamm_sm
        LD50_bg_bird_md=trex_obj.LD50_bg_bird_md
        LD50_bg_mamm_md=trex_obj.LD50_bg_mamm_md
        LD50_bg_bird_lg=trex_obj.LD50_bg_bird_lg
        LD50_bg_mamm_lg=trex_obj.LD50_bg_mamm_lg
...
def table_15(trex_obj):
        ...
        """
        #table 15
        LD50_bl_bird_sm=trex_obj.LD50_bl_bird_sm
        LD50_bl_mamm_sm=trex_obj.LD50_bl_mamm_sm
        LD50_bl_bird_md=trex_obj.LD50_bl_bird_md
        LD50_bl_mamm_md=trex_obj.LD50_bl_mamm_md
        LD50_bl_bird_lg=trex_obj.LD50_bl_bird_lg
        LD50_bl_mamm_lg=trex_obj.LD50_bl_mamm_lg
...
def table_5_qaqc(trex_obj):
        ...
        sa_bird_1_s_exp=trex_obj.sa_bird_1_s_out_exp
        sa_bird_2_s_exp=trex_obj.sa_bird_2_s_out_exp
        sc_bird_s_exp=trex_obj.sc_bird_s_out_exp
        sa_mamm_1_s_exp=trex_obj.sa_mamm_1_s_out_exp
        sa_mamm_2_s_exp=trex_obj.sa_mamm_2_s_out_exp
        sc_mamm_s_exp=trex_obj.sc_mamm_s_out_exp
        
        sa_bird_1_m_exp=trex_obj.sa_bird_1_m_out_exp
        sa_bird_2_m_exp=trex_obj.sa_bird_2_m_out_exp
        sc_bird_m_exp=trex_obj.sc_bird_m_out_exp
        sa_mamm_1_m_exp=trex_obj.sa_mamm_1_m_out_exp
        sa_mamm_2_m_exp=trex_obj.sa_mamm_2_m_out_exp
        sc_mamm_m_exp=trex_obj.sc_mamm_m_out_exp
             
        sa_bird_1_l_exp=trex_obj.sa_bird_1_l_out_exp
        sa_bird_2_l_exp=trex_obj.sa_bird_2_l_out_exp
        sc_bird_l_exp=trex_obj.sc_bird_l_out_exp
        sa_mamm_1_l_exp=trex_obj.sa_mamm_1_l_out_exp
        sa_mamm_2_l_exp=trex_obj.sa_mamm_2_l_out_exp
        sc_mamm_l_exp=trex_obj.sc_mamm_l_out_exp
...
def table_6_qaqc(trex_obj):
        ...
        EEC_diet_SG_exp=trex_obj.EEC_diet_SG_BL_out_exp
        EEC_diet_TG_exp=trex_obj.EEC_diet_TG_BL_out_exp
        EEC_diet_BP_exp=trex_obj.EEC_diet_BP_BL_out_exp
        EEC_diet_FR_exp=trex_obj.EEC_diet_FR_BL_out_exp
        EEC_diet_AR_exp=trex_obj.EEC_diet_AR_BL_out_exp
...
def table_7_qaqc(trex_obj):
        ...
        EEC_dose_bird_SG_sm_exp=trex_obj.EEC_dose_bird_SG_BL_sm_out_exp
        EEC_dose_bird_SG_md_exp=trex_obj.EEC_dose_bird_SG_BL_md_out_exp
        EEC_dose_bird_SG_lg_exp=trex_obj.EEC_dose_bird_SG_BL_lg_out_exp
        EEC_dose_bird_TG_sm_exp=trex_obj.EEC_dose_bird_TG_BL_sm_out_exp
        EEC_dose_bird_TG_md_exp=trex_obj.EEC_dose_bird_TG_BL_md_out_exp
        EEC_dose_bird_TG_lg_exp=trex_obj.EEC_dose_bird_TG_BL_lg_out_exp
        EEC_dose_bird_BP_sm_exp=trex_obj.EEC_dose_bird_BP_BL_sm_out_exp
        EEC_dose_bird_BP_md_exp=trex_obj.EEC_dose_bird_BP_BL_md_out_exp
        EEC_dose_bird_BP_lg_exp=trex_obj.EEC_dose_bird_BP_BL_lg_out_exp
        EEC_dose_bird_FP_sm_exp=trex_obj.EEC_dose_bird_FP_BL_sm_out_exp
        EEC_dose_bird_FP_md_exp=trex_obj.EEC_dose_bird_FP_BL_md_out_exp
        EEC_dose_bird_FP_lg_exp=trex_obj.EEC_dose_bird_FP_BL_lg_out_exp
        EEC_dose_bird_AR_sm_exp=trex_obj.EEC_dose_bird_AR_BL_sm_out_exp
        EEC_dose_bird_AR_md_exp=trex_obj.EEC_dose_bird_AR_BL_md_out_exp
        EEC_dose_bird_AR_lg_exp=trex_obj.EEC_dose_bird_AR_BL_lg_out_exp
        EEC_dose_bird_SE_sm_exp=trex_obj.EEC_dose_bird_SE_BL_sm_out_exp
        EEC_dose_bird_SE_md_exp=trex_obj.EEC_dose_bird_SE_BL_md_out_exp
        EEC_dose_bird_SE_lg_exp=trex_obj.EEC_dose_bird_SE_BL_lg_out_exp
...
def table_7_add_qaqc(trex_obj):
        ...
        ARQ_bird_SG_sm_exp=trex_obj.ARQ_bird_SG_BL_sm_out_exp
        ARQ_bird_SG_md_exp=trex_obj.ARQ_bird_SG_BL_md_out_exp
        ARQ_bird_SG_lg_exp=trex_obj.ARQ_bird_SG_BL_lg_out_exp
        ARQ_bird_TG_sm_exp=trex_obj.ARQ_bird_TG_BL_sm_out_exp
        ARQ_bird_TG_md_exp=trex_obj.ARQ_bird_TG_BL_md_out_exp
        ARQ_bird_TG_lg_exp=trex_obj.ARQ_bird_TG_BL_lg_out_exp
        ARQ_bird_BP_sm_exp=trex_obj.ARQ_bird_BP_BL_sm_out_exp
        ARQ_bird_BP_md_exp=trex_obj.ARQ_bird_BP_BL_md_out_exp
        ARQ_bird_BP_lg_exp=trex_obj.ARQ_bird_BP_BL_lg_out_exp
        ARQ_bird_FP_sm_exp=trex_obj.ARQ_bird_FP_BL_sm_out_exp
        ARQ_bird_FP_md_exp=trex_obj.ARQ_bird_FP_BL_md_out_exp
        ARQ_bird_FP_lg_exp=trex_obj.ARQ_bird_FP_BL_lg_out_exp
        ARQ_bird_AR_sm_exp=trex_obj.ARQ_bird_AR_BL_sm_out_exp
        ARQ_bird_AR_md_exp=trex_obj.ARQ_bird_AR_BL_md_out_exp
        ARQ_bird_AR_lg_exp=trex_obj.ARQ_bird_AR_BL_lg_out_exp
        ARQ_bird_SE_sm_exp=trex_obj.ARQ_bird_SE_BL_sm_out_exp
        ARQ_bird_SE_md_exp=trex_obj.ARQ_bird_SE_BL_md_out_exp
        ARQ_bird_SE_lg_exp=trex_obj.ARQ_bird_SE_BL_lg_out_exp
...
def table_8_qaqc(trex_obj):
        ...
        ARQ_diet_bird_SG_A_exp=trex_obj.ARQ_diet_bird_SG_A_BL_out_exp
        ARQ_diet_bird_SG_C_exp=trex_obj.ARQ_diet_bird_SG_C_BL_out_exp
        ARQ_diet_bird_TG_A_exp=trex_obj.ARQ_diet_bird_TG_A_BL_out_exp
        ARQ_diet_bird_TG_C_exp=trex_obj.ARQ_diet_bird_TG_C_BL_out_exp
        ARQ_diet_bird_BP_A_exp=trex_obj.ARQ_diet_bird_BP_A_BL_out_exp
        ARQ_diet_bird_BP_C_exp=trex_obj.ARQ_diet_bird_BP_C_BL_out_exp
        ARQ_diet_bird_FP_A_exp=trex_obj.ARQ_diet_bird_FP_A_BL_out_exp
        ARQ_diet_bird_FP_C_exp=trex_obj.ARQ_diet_bird_FP_C_BL_out_exp
        ARQ_diet_bird_AR_A_exp=trex_obj.ARQ_diet_bird_AR_A_BL_out_exp
        ARQ_diet_bird_AR_C_exp=trex_obj.ARQ_diet_bird_AR_C_BL_out_exp
...
def table_9_qaqc(trex_obj):
        ...
        EEC_dose_mamm_SG_sm_exp=trex_obj.EEC_dose_mamm_SG_sm_BL_out_exp
        EEC_dose_mamm_SG_md_exp=trex_obj.EEC_dose_mamm_SG_md_BL_out_exp
        EEC_dose_mamm_SG_lg_exp=trex_obj.EEC_dose_mamm_SG_lg_BL_out_exp
        EEC_dose_mamm_TG_sm_exp=trex_obj.EEC_dose_mamm_TG_sm_BL_out_exp
        EEC_dose_mamm_TG_md_exp=trex_obj.EEC_dose_mamm_TG_md_BL_out_exp
        EEC_dose_mamm_TG_lg_exp=trex_obj.EEC_dose_mamm_TG_lg_BL_out_exp
        EEC_dose_mamm_BP_sm_exp=trex_obj.EEC_dose_mamm_BP_sm_BL_out_exp
        EEC_dose_mamm_BP_md_exp=trex_obj.EEC_dose_mamm_BP_md_BL_out_exp
        EEC_dose_mamm_BP_lg_exp=trex_obj.EEC_dose_mamm_BP_lg_BL_out_exp
        EEC_dose_mamm_FP_sm_exp=trex_obj.EEC_dose_mamm_FP_sm_BL_out_exp
        EEC_dose_mamm_FP_md_exp=trex_obj.EEC_dose_mamm_FP_md_BL_out_exp
        EEC_dose_mamm_FP_lg_exp=trex_obj.EEC_dose_mamm_FP_lg_BL_out_exp
        EEC_dose_mamm_AR_sm_exp=trex_obj.EEC_dose_mamm_AR_sm_BL_out_exp
        EEC_dose_mamm_AR_md_exp=trex_obj.EEC_dose_mamm_AR_md_BL_out_exp
        EEC_dose_mamm_AR_lg_exp=trex_obj.EEC_dose_mamm_AR_lg_BL_out_exp
        EEC_dose_mamm_SE_sm_exp=trex_obj.EEC_dose_mamm_SE_sm_BL_out_exp
        EEC_dose_mamm_SE_md_exp=trex_obj.EEC_dose_mamm_SE_md_BL_out_exp
        EEC_dose_mamm_SE_lg_exp=trex_obj.EEC_dose_mamm_SE_lg_BL_out_exp
...
#########
        ARQ_dose_mamm_SG_sm_exp=trex_obj.ARQ_dose_mamm_SG_sm_BL_out_exp
        CRQ_dose_mamm_SG_sm_exp=trex_obj.CRQ_dose_mamm_SG_sm_BL_out_exp
        ARQ_dose_mamm_SG_md_exp=trex_obj.ARQ_dose_mamm_SG_md_BL_out_exp
        CRQ_dose_mamm_SG_md_exp=trex_obj.CRQ_dose_mamm_SG_md_BL_out_exp
        ARQ_dose_mamm_SG_lg_exp=trex_obj.ARQ_dose_mamm_SG_lg_BL_out_exp
        CRQ_dose_mamm_SG_lg_exp=trex_obj.CRQ_dose_mamm_SG_lg_BL_out_exp
        
        ARQ_dose_mamm_TG_sm_exp=trex_obj.ARQ_dose_mamm_TG_sm_BL_out_exp
        CRQ_dose_mamm_TG_sm_exp=trex_obj.CRQ_dose_mamm_TG_sm_BL_out_exp
        ARQ_dose_mamm_TG_md_exp=trex_obj.ARQ_dose_mamm_TG_md_BL_out_exp
        CRQ_dose_mamm_TG_md_exp=trex_obj.CRQ_dose_mamm_TG_md_BL_out_exp
        ARQ_dose_mamm_TG_lg_exp=trex_obj.ARQ_dose_mamm_TG_lg_BL_out_exp
        CRQ_dose_mamm_TG_lg_exp=trex_obj.CRQ_dose_mamm_TG_lg_BL_out_exp
        
        ARQ_dose_mamm_BP_sm_exp=trex_obj.ARQ_dose_mamm_BP_sm_BL_out_exp
        CRQ_dose_mamm_BP_sm_exp=trex_obj.CRQ_dose_mamm_BP_sm_BL_out_exp
        ARQ_dose_mamm_BP_md_exp=trex_obj.ARQ_dose_mamm_BP_md_BL_out_exp
        CRQ_dose_mamm_BP_md_exp=trex_obj.CRQ_dose_mamm_BP_md_BL_out_exp
        ARQ_dose_mamm_BP_lg_exp=trex_obj.ARQ_dose_mamm_BP_lg_BL_out_exp
        CRQ_dose_mamm_BP_lg_exp=trex_obj.CRQ_dose_mamm_BP_lg_BL_out_exp
        
        ARQ_dose_mamm_FP_sm_exp=trex_obj.ARQ_dose_mamm_FP_sm_BL_out_exp
        CRQ_dose_mamm_FP_sm_exp=trex_obj.CRQ_dose_mamm_FP_sm_BL_out_exp
        ARQ_dose_mamm_FP_md_exp=trex_obj.ARQ_dose_mamm_FP_md_BL_out_exp
        CRQ_dose_mamm_FP_md_exp=trex_obj.CRQ_dose_mamm_FP_md_BL_out_exp
        ARQ_dose_mamm_FP_lg_exp=trex_obj.ARQ_dose_mamm_FP_lg_BL_out_exp
        CRQ_dose_mamm_FP_lg_exp=trex_obj.CRQ_dose_mamm_FP_lg_BL_out_exp
        
        ARQ_dose_mamm_AR_sm_exp=trex_obj.ARQ_dose_mamm_AR_sm_BL_out_exp
        CRQ_dose_mamm_AR_sm_exp=trex_obj.CRQ_dose_mamm_AR_sm_BL_out_exp
        ARQ_dose_mamm_AR_md_exp=trex_obj.ARQ_dose_mamm_AR_md_BL_out_exp
        CRQ_dose_mamm_AR_md_exp=trex_obj.CRQ_dose_mamm_AR_md_BL_out_exp
        ARQ_dose_mamm_AR_lg_exp=trex_obj.ARQ_dose_mamm_AR_lg_BL_out_exp
        CRQ_dose_mamm_AR_lg_exp=trex_obj.CRQ_dose_mamm_AR_lg_BL_out_exp
        
        ARQ_dose_mamm_SE_sm_exp=trex_obj.ARQ_dose_mamm_SE_sm_BL_out_exp
        CRQ_dose_mamm_SE_sm_exp=trex_obj.CRQ_dose_mamm_SE_sm_BL_out_exp
        ARQ_dose_mamm_SE_md_exp=trex_obj.ARQ_dose_mamm_SE_md_BL_out_exp
        CRQ_dose_mamm_SE_md_exp=trex_obj.CRQ_dose_mamm_SE_md_BL_out_exp
        ARQ_dose_mamm_SE_lg_exp=trex_obj.ARQ_dose_mamm_SE_lg_BL_out_exp
        CRQ_dose_mamm_SE_lg_exp=trex_obj.CRQ_dose_mamm_SE_lg_BL_out_exp
...
def table_11_qaqc(trex_obj):
        ...
        ARQ_diet_mamm_SG_exp=trex_obj.ARQ_diet_mamm_SG_BL_out_exp
        CRQ_diet_mamm_SG_exp=trex_obj.CRQ_diet_mamm_SG_BL_out_exp
        ARQ_diet_mamm_TG_exp=trex_obj.ARQ_diet_mamm_TG_BL_out_exp
        CRQ_diet_mamm_TG_exp=trex_obj.CRQ_diet_mamm_TG_BL_out_exp
        ARQ_diet_mamm_BP_exp=trex_obj.ARQ_diet_mamm_BP_BL_out_exp
        CRQ_diet_mamm_BP_exp=trex_obj.CRQ_diet_mamm_BP_BL_out_exp
        ARQ_diet_mamm_FP_exp=trex_obj.ARQ_diet_mamm_FP_BL_out_exp
        CRQ_diet_mamm_FP_exp=trex_obj.CRQ_diet_mamm_FP_BL_out_exp
        ARQ_diet_mamm_AR_exp=trex_obj.ARQ_diet_mamm_AR_BL_out_exp
        CRQ_diet_mamm_AR_exp=trex_obj.CRQ_diet_mamm_AR_BL_out_exp
...
def table_15_qaqc(trex_obj):
        ...
        LD50_bl_bird_sm_exp=trex_obj.LD50_bl_bird_sm
        LD50_bl_mamm_sm_exp=trex_obj.LD50_bl_mamm_sm
        LD50_bl_bird_md_exp=trex_obj.LD50_bl_bird_md
        LD50_bl_mamm_md_exp=trex_obj.LD50_bl_mamm_md
        LD50_bl_bird_lg_exp=trex_obj.LD50_bl_bird_lg
        LD50_bl_mamm_lg_exp=trex_obj.LD50_bl_mamm_lg
