...
def trex_input_page(request, model='', header='', form_data=None):
    ...
    html += str(trex_parameters.trexInp_chem(form_data))
    html += """</table><table class="input_table tab tab_Application tab_Chemical">
                            <tr><th colspan="2" scope="col"><label for="id_num_apps">Number of Applications:</label></th>
                                <td colspan="3" scope="col"><select name="num_apps" id="id_num_apps">
                            ...
                            <tr class="tab_noa1">
                                <td>1</td>
                                <td><input type="text" size="5" name="rate1" id="id_rate-1" value="4"/></td>
                                <td><input type="text" size="5" name="day1" id="id_day-1" value="0" /></td>
                            </tr>"""
    html += """</table><table class="input_table tab tab_Avian" style="display:none">"""
    html += str(trex_parameters.trexInp_bird(form_data))
    html += """</table><table class="input_table tab tab_Mammal" style="display:none">"""
    html += str(trex_parameters.trexInp_mammal(form_data))
