...
####################################################
    ...
    for i in range(noa):
        if i<1:    
            Apt_temp = request.POST.get('Apt')
            Apt.append(Apt_temp)
            Date_inp_temp=request.POST.get('Date_apt')
            Date_inp.append(Date_inp_temp)
            DayRe_temp = request.POST.get('DayRe')
            DayRe.append(DayRe_temp)
            
            CAM_1 = request.POST.get('CAM_1')
            CAM_2 = request.POST.get('CAM_2')
            CAM_3 = request.POST.get('CAM_3')
            CAM_4 = request.POST.get('CAM_4')  
            DEPI = request.POST.get('DEPI')
            
            Ap_m_temp = request.POST.get('Ap_m')
            Ap_mp.append(przm_exams_model.Ap_m_select(Ap_m_temp, CAM_1, CAM_2, CAM_3, CAM_4)[0])
            Ar_temp = request.POST.get('Ar')
            ...
            j=i+1
            Apt_temp = request.POST.get('Apt'+str(j))
            Apt.append(Apt_temp)
            Date_inp_temp=request.POST.get('Date_apt'+str(j))
            Date_inp.append(Date_inp_temp)             
            DayRe_temp = request.POST.get('DayRe'+str(j))
            DayRe.append(DayRe_temp)
            
            CAM_1 = request.POST.get('CAM_1_'+str(j))
            CAM_2 = request.POST.get('CAM_2_'+str(j))
            CAM_3 = request.POST.get('CAM_3_'+str(j))
            CAM_4 = request.POST.get('CAM_4_'+str(j)) 
            DEPI = request.POST.get('DEPI_'+str(j))
            
            Ap_m_temp = request.POST.get('Ap_m'+str(j))
            Ap_mp.append(przm_exams_model.Ap_m_select(Ap_m_temp, CAM_1, CAM_2, CAM_3, CAM_4)[0])
            Ar_temp = request.POST.get('Ar'+str(j))
            Ar.append(float(Ar_temp))
