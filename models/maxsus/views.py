...
algorithm = '' \
            ...
            '<img src = \"/static_qed/images/latex/maxsus/maxsus_1.png\" alt=\"Maxsus_1\">' \
            '<p>At equilibrium:</p>' \
            '<img src = \"/static_qed/images/latex/maxsus/maxsus_2.png\" alt=\"Maxsus_2\">'
...
description = '<p> The maximum sustainable yield (MSY) model was developed to maintain the population size ' \
              ...
              '<img src = "/static_qed/images/latex/maxsus/maxsus_des_1.png" alt="Maximum Sustainable Yield Model"> ' \
