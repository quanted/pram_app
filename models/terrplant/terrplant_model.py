...
class terrplant(object):
    def __init__(self, set_variables=True, run_methods=True, version_terrplant='1.2.2', 
            ...
            drift_fraction=1, EC25_for_nonlisted_seedling_emergence_monocot=1, EC25_for_nonlisted_seedling_emergence_dicot=1, 
            NOAEC_for_listed_seedling_emergence_monocot=1, NOAEC_for_listed_seedling_emergence_dicot=1,
        ...
        if set_variables:
            if vars_dict != None:
                ...
                self.set_variables(version_terrplant,run_type,application_rate,incorporation_depth,runoff_fraction,drift_fraction,EC25_for_nonlisted_seedling_emergence_monocot,EC25_for_nonlisted_seedling_emergence_dicot,NOAEC_for_listed_seedling_emergence_monocot,NOAEC_for_listed_seedling_emergence_dicot,chemical_name,pc_code,use,application_method,application_form,solubility)
    ...
    def set_default_variables(self):
        ...
        self.EC25_for_nonlisted_seedling_emergence_monocot = 1
        self.NOAEC_for_listed_seedling_emergence_monocot = 1
        self.EC25_for_nonlisted_seedling_emergence_dicot = 1
        self.NOAEC_for_listed_seedling_emergence_dicot = 1
        ...
        self.solubility = 1
        self.EC25_for_nonlisted_vegetative_vigor_monocot = 1
        self.NOAEC_for_listed_vegetative_vigor_monocot = 1
        self.EC25_for_nonlisted_vegetative_vigor_dicot = 1
        self.NOAEC_for_listed_vegetative_vigor_dicot = 1
    ...
    def set_variables(self, version_terrplant,run_type, application_rate, incorporation_depth, runoff_fraction, 
        ...
        all_dic = {"version_terrplant":self.version_terrplant, "run_type":self.run_type, "application_rate":self.application_rate, 
                    ...
                    "EC25_for_nonlisted_seedling_emergence_monocot":self.EC25_for_nonlisted_seedling_emergence_monocot, 
                    "EC25_for_nonlisted_seedling_emergence_dicot":self.EC25_for_nonlisted_seedling_emergence_dicot, 
                    "NOAEC_for_listed_seedling_emergence_monocot":self.NOAEC_for_listed_seedling_emergence_monocot, 
                    "NOAEC_for_listed_seedling_emergence_dicot":self.NOAEC_for_listed_seedling_emergence_dicot, "chemical_name":self.chemical_name,
