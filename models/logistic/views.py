...
algorithm = '' \
            ...
            '<img src = \"/pram/static/images/latex/logistic/logistic_1.png\" alt=\"Logistic_1\">'\
            '<p>whose solution is:</p>'\
            '<img src = \"/pram/static/images/latex/logistic/logistic_2.png\" alt=\"Logistic_2\">'
...
description = '<p>Developed by Belgian mathematician '\
              ...
              '</p><img src = \"/pram/static/images/latex/logistic/logistic_des_1.png\" alt=\"Logisitic Model\">'\
              '<ul class=\"bullet\">'\
