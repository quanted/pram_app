...
<img src = "/static/images/latex/sip/sip_image1.png" alt="SIP_1">
<p>For mammals the daily water intake rates are calculated below:</p>
<img src = "/static/images/latex/sip/sip_image2.png" alt="SIP_2">

<p>Dose from drinking water:</p>
<img src = "/static/images/latex/sip/sip_image3.png" alt="SIP_3">


<p>Adjusted acute toxicity values for birds:</p>
<img src = "/static/images/latex/sip/sip_image4.png" alt="SIP_4">


<p>Adjusted acute toxicity values for mammals:</p>
<img src = "/static/images/latex/sip/sip_image5.png" alt="SIP_5">


<p>Daily food intake rate:</p>
<img src = "/static/images/latex/sip/sip_image6.png" alt="SIP_6">


<p>Dose equivalent toxicity for birds:</p>
<img src = "/static/images/latex/sip/sip_image7.png" alt="SIP_7">


<p>Dose equivalent toxicity for mammals:</p>
<img src = "/static/images/latex/sip/sip_image8.png" alt="SIP_8">'
...
<p>
Example reports documenting the use of SIP in reregistration eligibility documents and pesticide effects determinations for federally threatened and endangered species:
</p>
<ul class="bullet">
