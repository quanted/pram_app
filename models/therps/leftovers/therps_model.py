...
class therps(object):
    def __init__(self, run_type, chem_name, use, formu_name, a_i, h_l, n_a, i_a, a_r, avian_ld50, avian_lc50,
        ...
        all_dic = {"chem_name": chem_name, "use": use, "formu_name": formu_name, "a_i": a_i, "h_l": h_l, "n_a": n_a,
                   "i_a": i_a, "a_r": a_r, "avian_ld50": avian_ld50, "avian_lc50": avian_lc50,
                   "avian_NOAEC": avian_NOAEC, "avian_NOAEL": avian_NOAEL,
                   "Species_of_the_tested_bird_avian_ld50": Species_of_the_tested_bird_avian_ld50,
                   "Species_of_the_tested_bird_avian_lc50": Species_of_the_tested_bird_avian_lc50,
                   "Species_of_the_tested_bird_avian_NOAEC": Species_of_the_tested_bird_avian_NOAEC,
                   "Species_of_the_tested_bird_avian_NOAEL": Species_of_the_tested_bird_avian_NOAEL,
                   "bw_avian_ld50": bw_avian_ld50,
                   "bw_avian_lc50": bw_avian_lc50, "bw_avian_NOAEC": bw_avian_NOAEC, "bw_avian_NOAEL": bw_avian_NOAEL,
                   "mineau_scaling_factor": mineau_scaling_factor, "bw_herp_a_sm": bw_herp_a_sm,
                   "bw_herp_a_md": bw_herp_a_md,
                   "bw_herp_a_lg": bw_herp_a_lg, "wp_herp_a_sm": wp_herp_a_sm, "wp_herp_a_md": wp_herp_a_md,
                   "wp_herp_a_lg": wp_herp_a_lg, "c_mamm_a": c_mamm_a, "c_herp_a": c_herp_a, "run_type": self.run_type}
