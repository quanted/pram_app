...
<img src = "/static/images/latex/rice/rice.eqn1.gif">
<p>The Tier I Rice Conceptual Model:</p>
<img src = "/static/images/latex/rice/rice.eqn2.gif">
<p>It is more customary to describe a rice paddy in terms of depth rather than volume or mass. Therefore, the following equations are defined:</p>
<img src = "/static/images/latex/rice/rice.eqn3.gif">
<p>Further, the input mass per unit area as:</p>
<img src = "/static/images/latex/rice/rice.eqn4.gif">
<p>After substititution, the conceptual model with commonly understood parameters is the following:</p>
<img src = "/static/images/latex/rice/rice.eqn5.gif">'

history = '<p>User History</p>'

references = '<p>
EPA guidance on the Tier I Rice Program can be found here:
</p>
<ul class="bullet">
...
<p>
Presentations/posters/abstracts/reports on the subject of EPA's ecological risk assessment models, including the Tier I Rice model .
</p>
<ul class="bullet">
