...
def pisces_map_page(request, model='pisces', header='none'):
    ...
    html += pisces_map_page_html(request, model, header)
    html += render_to_string('04ubertext_end_drupal.html', {})

    return html


def pisces_map_page_html(request, model, dummy):
    return render_to_string('pisces/pisces_map_page.html', {})
