...
def sipQaqc(model, csv_path):
    ...
    pd_obj_inputs = pd.read_csv(csv_path, index_col=1, header=None, skiprows=1, skipfooter=32, engine='python')
    ...
    pd_obj_exp_out = pd.read_csv(csv_path, index_col=1, header=None, skiprows=30, engine='python')
