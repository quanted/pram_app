...
terrplant_obj.lms_expected = lms[0]
terrplant_obj.lds_expected = lds[0]
terrplant_obj.nmv_expected = nmv[0]
terrplant_obj.ndv_expected = ndv[0]
terrplant_obj.lmv_expected = lmv[0]
terrplant_obj.ldv_expected = ldv[0]
...
# terrplant_obj.nmsRQdry_results_expected = out_fun_nmsRQdry[0]
# terrplant_obj.nmsRQsemi_results_expected = out_fun_nmsRQsemi[0]
# terrplant_obj.nmsRQspray_results_expected = out_fun_nmsRQspray[0]
# terrplant_obj.lmsRQdry_results_expected = out_fun_lmsRQdry[0]
# terrplant_obj.lmsRQsemi_results_expected = out_fun_lmsRQsemi[0]
# terrplant_obj.lmsRQspray_results_expected = out_fun_lmsRQspray[0]
# terrplant_obj.ndsRQdry_results_expected = out_fun_ndsRQdry[0]
# terrplant_obj.ndsRQsemi_results_expected = out_fun_ndsRQsemi[0]
# terrplant_obj.ndsRQspray_results_expected = out_fun_ndsRQspray[0]
# terrplant_obj.ldsRQdry_results_expected = out_fun_ldsRQdry[0]
...
#     def testRundry_out_in(self):
#             fun = self.terrplant_obj.runsemi()
...
#     def testRundry_out_in(self):
#             fun = self.terrplant_obj.totaldry()
...
#     def testRundry_out_in(self):
#             fun = self.terrplant_obj.totalsemi()
...
#     def testRundry_out_in(self):
#             fun = self.terrplant_obj.nmsRQdry()
...
#     def testRundry_out_in(self):
#             fun = self.terrplant_obj.LOCnmsdry()
...
#             fun = self.terrplant_obj.nmsRQsemi()
...
#     def testRunsemi_out_in(self):
#             fun = self.terrplant_obj.LOCnmssemi()
...
#             fun = self.terrplant_obj.nmsRQspray()
...
#     def testRunspray_out_in(self):
#             fun = self.terrplant_obj.LOCnmsspray()
...
#     def testRundry_out_in(self):
#             fun = self.terrplant_obj.lmsRQdry()
...
#     def testRundry_out_in(self):
#             fun = self.terrplant_obj.LOClmsdry()
...
#     def testRunsemi_out_in(self):
#             fun = self.terrplant_obj.lmsRQsemi()
...
#     def testRunsemi_out_in(self):
#             fun = self.terrplant_obj.LOClmssemi()
...
#     def testRunspray_out_in(self):
#             fun = self.terrplant_obj.lmsRQspray()
...
#     def testRunspray_out_in(self):
#             fun = self.terrplant_obj.LOClmsspray()
...
#     def testRundry_out_in(self):
#             fun = self.terrplant_obj.ndsRQdry()
...
#     def testRundry_out_in(self):
#             fun = self.terrplant_obj.LOCndsdry()
...
#     def testRunsemi_out_in(self):
#             fun = self.terrplant_obj.ndsRQsemi()
...
#     def testRunsemi_out_in(self):
#             fun = self.terrplant_obj.LOCndssemi()
...
#     def testRunspray_out_in(self):
#             fun = self.terrplant_obj.ndsRQspray()
...
#     def testRunspray_out_in(self):
#             fun = self.terrplant_obj.LOCndsspray()
...
#     def testRundry_out_in(self):
#             fun = self.terrplant_obj.ldsRQdry()
...
#     def testRundry_out_in(self):
#             fun = self.terrplant_obj.LOCldsdry()
...
#     def testRunsemi_out_in(self):
#             fun = self.terrplant_obj.ldsRQsemi()
...
#     def testRunsemi_out_in(self):
#             fun = self.terrplant_obj.LOCldssemi()
...
#     def testRunspray_out_in(self):
#             fun = self.terrplant_obj.ldsRQspray()
...
#     def testRunspray_out_in(self):
#             fun = self.terrplant_obj.LOCldsspray()
