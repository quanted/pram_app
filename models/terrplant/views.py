...
algorithm = '<p>TerrPlant derives estimated exposure concentrations (EECs) of pesticide in runoff and in drift. From the derived EECs TerrPlant develops risk quotients (RQs) are developed for non-listed and listed species of monocots and dicots inhabiting dry and semi-aquatic areas adjacent to treatment sites using the equations below.</p>' \
            ...
            '<img src = \"/pram/static/images/latex/terrplant/terrplant_image1.png\" alt=\"Terrplant_1\">' \
            '<p>Runoff to semi-aquatic areas:</p>' \
            '<img src = \"/pram/static/images/latex/terrplant/terrplant_image2.png\" alt=\"Terrplant_2\">' \
            '<p>Spray drift:</p>' \
            '<img src = \"/pram/static/images/latex/terrplant/terrplant_image3.png\" alt=\"Terrplant_3\">' \
            '<p>Total for dry areas:</p>' \
            '<img src = \"/pram/static/images/latex/terrplant/terrplant_image4.png\" alt=\"Terrplant_4\">' \
            '<p>Total for semi-aquatic areas:</p>' \
            '<img src = \"/pram/static/images/latex/terrplant/terrplant_image5.png\" alt=\"Terrplant_5\">' \
            ...
            '<img src = \"/pram/static/images/latex/terrplant/terrplant_image6.png\" alt=\"Terrplant_6\">' \
            '<p>Risk quotient calculation for listed species:</p>' \
            '<img src = \"/pram/static/images/latex/terrplant/terrplant_image7.png\" alt=\"Terrplant_7\">'
