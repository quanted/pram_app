...
class terrplant(object):
    ...
    #         vars_dict=None,):
    def __init__(self, set_variables=True, run_methods=True, args={}):
        all_dic = self.set_default_variables(args)
        ...
        self.set_variables(all_dic)

    def set_default_variables(self, args):
        # logger.info(args)
    ...
    def set_variables(self, all_dic):
