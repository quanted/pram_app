...
algorithm = '' \
            ...
            '<img src = \"/static_qed/images/latex/leslie/leslie_1.png\" alt=\"Leslie Matrix_1"\>' \
            ...
            '<img src = \"/static_qed/images/latex/leslie/leslie_2.png\" alt=\"Leslie Matrix_2\">' \
            '<p>The Leslie model is described by the following two equations:</p>' \
            '<img src = \"/static_qed/images/latex/leslie/leslie_3.png\" alt=\"Leslie Matrix_3\">' \
            ...
            '<img src = \"/static_qed/images/latex/leslie/leslie_4.png\" alt=\"Leslie Matrix_4\">' \
            '<p>more compactly:</p>' \
            '<img src = \"/static_qed/images/latex/leslie/leslie_5.png\" alt=\"Leslie Matrix_5\">' \
...
description = '<p>Leslie matrix (model) is a discrete, non-negative, age-structured model,' \
                ...
                '</p>' \
                '<img src = \"/static_qed/images/latex/leslie/leslie_des_1.png"\ alt=\"Leslie Matrix_1\">' \
                '<p>' \
                'which can be expanded into:' \
                '</p>' \
                '<img src = \"/static_qed/images/latex/leslie/leslie_des_2.png\" alt=\"Leslie Matrix_2\">' \
                '<p>' \
