...
urlpatterns = patterns('views',
    ...
    (r'^eco/ore/', include('models.ore.urls')),
    ...
    (r'^eco/(?P<model>.*?)/qaqc/(?P<runID>.*?)/?$', 'qaqc.qaqcRunView'),
    (r'^eco/(?P<model>.*?)/qaqc/?$', 'qaqc.qaqcPage'),
    (r'^eco/(?P<model>.*?)/history/?$', 'history.historyPage'),
    (r'^eco/(?P<model>.*?)/history/query?$', 'history.historyQueryAjax'),
    (r'^eco/(?P<model>.*?)/history/revisit?$', 'history.historyPageRevist'),
