...
def gett1data(agdrift_obj):
    data = { 
        ...
        "Value": [agdrift_obj.ecosystem_type, agdrift_obj.application_method, agdrift_obj.aquatic_body_type, agdrift_obj.drop_size, agdrift_obj.out_sim_scenario_chk,],
    }
    return data
...
def gett2data(agdrift_obj):
    ...
    data = { 
        ...
        "Value": ['%.5f' % agdrift_obj.out_avg_dep_foa,'%.5f' % agdrift_obj.out_avg_dep_gha,'%.5f' % agdrift_obj.out_avg_dep_lbac, '%.5f' % agdrift_obj.out_avg_waterconc_ngl, '%.5f' % agdrift_obj.out_avg_field_dep_mgcm, '%.d' % int(agdrift_obj.downwind_distance),],
    }
    return data
