...
def fellerarley_input_page(request, model='', header='', form_data=None):
    from . import fellerarley_parameters
    ...
    html += render_to_string('04uberinput_start_drupal.html', {
        ...
        'TITLE': header},
        request=request)
    html += str(fellerarley_parameters.fellerarleyInp(form_data))
