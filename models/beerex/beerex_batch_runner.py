...
logger = logging.getLogger("beerexBatchRunner")

class beerexBatchRunner():
    
    def runbeerexModel(self,config_properties,results_dict):
        if not results_dict:
            results_dict = {}
