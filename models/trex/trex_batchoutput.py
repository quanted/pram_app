...
def html_table(row_inp_all):
    while True:
        ...
        #############Inputs#################
            ...
            table_all_out = trex_tables.table_all(trex_obj_temp)
        ...
        ###Table 11#######
                ...
                jid_all.append(trex_obj_temp.jid)
                trex_obj_all.append(trex_obj_temp)    
                if iter == 1:
                    jid_batch.append(trex_obj_temp.jid)
######Output###########
...
def loop_html(thefile):
    ...
    sum_1 = trex_tables.table_sum_1(i, a_i, r_s, b_w, p_i, den, h_l, n_a, rate_out)
    sum_2 = trex_tables.table_sum_2(ld50_bird, lc50_bird, NOAEC_bird, NOAEL_bird, aw_bird_sm, aw_bird_md, aw_bird_lg, tw_bird_ld50, tw_bird_lc50, tw_bird_NOAEC, tw_bird_NOAEL, x)
    sum_3 = trex_tables.table_sum_3(ld50_mamm, lc50_mamm, NOAEC_mamm, NOAEL_mamm, aw_mamm_sm, aw_mamm_md, aw_mamm_lg, tw_mamm)
    ...
    if 'Broadcast-Granular' in Application_type:
        sum_6_BG = trex_tables.table_sum_6(Application_type_BG, 'Broadcast-Granular', EEC_diet_SG_BG_out, EEC_diet_TG_BG_out, EEC_diet_BP_BG_out, EEC_diet_FR_BG_out, EEC_diet_AR_BG_out)
        sum_7_BG = trex_tables.table_sum_7(EEC_dose_bird_SG_BG_sm_out, EEC_dose_bird_SG_BG_md_out, EEC_dose_bird_SG_BG_lg_out, EEC_dose_bird_TG_BG_sm_out, EEC_dose_bird_TG_BG_md_out, EEC_dose_bird_TG_BG_lg_out, EEC_dose_bird_BP_BG_sm_out, EEC_dose_bird_BP_BG_md_out, EEC_dose_bird_BP_BG_lg_out, EEC_dose_bird_FP_BG_sm_out, EEC_dose_bird_FP_BG_md_out, EEC_dose_bird_FP_BG_lg_out, EEC_dose_bird_AR_BG_sm_out, EEC_dose_bird_AR_BG_md_out, EEC_dose_bird_AR_BG_lg_out, EEC_dose_bird_SE_BG_sm_out, EEC_dose_bird_SE_BG_md_out, EEC_dose_bird_SE_BG_lg_out)
        sum_7_BG_add = trex_tables.table_sum_7_add(ARQ_bird_SG_BG_sm_out, ARQ_bird_SG_BG_md_out, ARQ_bird_SG_BG_lg_out, ARQ_bird_TG_BG_sm_out, ARQ_bird_TG_BG_md_out, ARQ_bird_TG_BG_lg_out, ARQ_bird_BP_BG_sm_out, ARQ_bird_BP_BG_md_out, ARQ_bird_BP_BG_lg_out, ARQ_bird_FP_BG_sm_out, ARQ_bird_FP_BG_md_out, ARQ_bird_FP_BG_lg_out, ARQ_bird_AR_BG_sm_out, ARQ_bird_AR_BG_md_out, ARQ_bird_AR_BG_lg_out, ARQ_bird_SE_BG_sm_out, ARQ_bird_SE_BG_md_out, ARQ_bird_SE_BG_lg_out)
        sum_8_BG = trex_tables.table_sum_8(ARQ_diet_bird_SG_A_BG_out, ARQ_diet_bird_SG_C_BG_out, ARQ_diet_bird_TG_A_BG_out, ARQ_diet_bird_TG_C_BG_out, ARQ_diet_bird_BP_A_BG_out, ARQ_diet_bird_BP_C_BG_out, ARQ_diet_bird_FP_A_BG_out, ARQ_diet_bird_FP_C_BG_out, ARQ_diet_bird_AR_A_BG_out, ARQ_diet_bird_AR_C_BG_out)
        sum_9_BG = trex_tables.table_sum_9(EEC_dose_mamm_SG_sm_BG_out, EEC_dose_mamm_SG_md_BG_out, EEC_dose_mamm_SG_lg_BG_out, EEC_dose_mamm_TG_sm_BG_out, EEC_dose_mamm_TG_md_BG_out, EEC_dose_mamm_TG_lg_BG_out, EEC_dose_mamm_BP_sm_BG_out, EEC_dose_mamm_BP_md_BG_out, EEC_dose_mamm_BP_lg_BG_out, EEC_dose_mamm_FP_sm_BG_out, EEC_dose_mamm_FP_md_BG_out, EEC_dose_mamm_FP_lg_BG_out, EEC_dose_mamm_AR_sm_BG_out, EEC_dose_mamm_AR_md_BG_out, EEC_dose_mamm_AR_lg_BG_out, EEC_dose_mamm_SE_sm_BG_out, EEC_dose_mamm_SE_md_BG_out, EEC_dose_mamm_SE_lg_BG_out)
        sum_10_BG = trex_tables.table_sum_10(ARQ_dose_mamm_SG_sm_BG_out, CRQ_dose_mamm_SG_sm_BG_out, ARQ_dose_mamm_SG_md_BG_out, CRQ_dose_mamm_SG_md_BG_out, ARQ_dose_mamm_SG_lg_BG_out, CRQ_dose_mamm_SG_lg_BG_out, ARQ_dose_mamm_TG_sm_BG_out, CRQ_dose_mamm_TG_sm_BG_out, ARQ_dose_mamm_TG_md_BG_out, CRQ_dose_mamm_TG_md_BG_out, ARQ_dose_mamm_TG_lg_BG_out, CRQ_dose_mamm_TG_lg_BG_out, ARQ_dose_mamm_BP_sm_BG_out, CRQ_dose_mamm_BP_sm_BG_out, ARQ_dose_mamm_BP_md_BG_out, CRQ_dose_mamm_BP_md_BG_out, ARQ_dose_mamm_BP_lg_BG_out, CRQ_dose_mamm_BP_lg_BG_out, ARQ_dose_mamm_FP_sm_BG_out, CRQ_dose_mamm_FP_sm_BG_out, ARQ_dose_mamm_FP_md_BG_out, CRQ_dose_mamm_FP_md_BG_out, ARQ_dose_mamm_FP_lg_BG_out, CRQ_dose_mamm_FP_lg_BG_out, ARQ_dose_mamm_AR_sm_BG_out, CRQ_dose_mamm_AR_sm_BG_out, ARQ_dose_mamm_AR_md_BG_out, CRQ_dose_mamm_AR_md_BG_out, ARQ_dose_mamm_AR_lg_BG_out, CRQ_dose_mamm_AR_lg_BG_out, ARQ_dose_mamm_SE_sm_BG_out, CRQ_dose_mamm_SE_sm_BG_out, ARQ_dose_mamm_SE_md_BG_out, CRQ_dose_mamm_SE_md_BG_out, ARQ_dose_mamm_SE_lg_BG_out, CRQ_dose_mamm_SE_lg_BG_out)
        sum_11_BG = trex_tables.table_sum_11(ARQ_diet_mamm_SG_BG_out, CRQ_diet_mamm_SG_BG_out, ARQ_diet_mamm_TG_BG_out, CRQ_diet_mamm_TG_BG_out, ARQ_diet_mamm_BP_BG_out, CRQ_diet_mamm_BP_BG_out, ARQ_diet_mamm_FP_BG_out, CRQ_diet_mamm_FP_BG_out, ARQ_diet_mamm_AR_BG_out, CRQ_diet_mamm_AR_BG_out)
        sum_14 = trex_tables.table_sum_14(LD50_bg_bird_sm_out, LD50_bg_mamm_sm_out, LD50_bg_bird_md_out, LD50_bg_mamm_md_out, LD50_bg_bird_lg_out, LD50_bg_mamm_lg_out)
    ...
    if 'Broadcast-Liquid' in Application_type:
        sum_6_BL = trex_tables.table_sum_6(Application_type_BL, 'Broadcast-Liquid', EEC_diet_SG_BL_out, EEC_diet_TG_BL_out, EEC_diet_BP_BL_out, EEC_diet_FR_BL_out, EEC_diet_AR_BL_out)
        sum_7_BL = trex_tables.table_sum_7(EEC_dose_bird_SG_BL_sm_out, EEC_dose_bird_SG_BL_md_out, EEC_dose_bird_SG_BL_lg_out, EEC_dose_bird_TG_BL_sm_out, EEC_dose_bird_TG_BL_md_out, EEC_dose_bird_TG_BL_lg_out, EEC_dose_bird_BP_BL_sm_out, EEC_dose_bird_BP_BL_md_out, EEC_dose_bird_BP_BL_lg_out, EEC_dose_bird_FP_BL_sm_out, EEC_dose_bird_FP_BL_md_out, EEC_dose_bird_FP_BL_lg_out, EEC_dose_bird_AR_BL_sm_out, EEC_dose_bird_AR_BL_md_out, EEC_dose_bird_AR_BL_lg_out, EEC_dose_bird_SE_BL_sm_out, EEC_dose_bird_SE_BL_md_out, EEC_dose_bird_SE_BL_lg_out)
        sum_7_BL_add = trex_tables.table_sum_7_add(ARQ_bird_SG_BL_sm_out, ARQ_bird_SG_BL_md_out, ARQ_bird_SG_BL_lg_out, ARQ_bird_TG_BL_sm_out, ARQ_bird_TG_BL_md_out, ARQ_bird_TG_BL_lg_out, ARQ_bird_BP_BL_sm_out, ARQ_bird_BP_BL_md_out, ARQ_bird_BP_BL_lg_out, ARQ_bird_FP_BL_sm_out, ARQ_bird_FP_BL_md_out, ARQ_bird_FP_BL_lg_out, ARQ_bird_AR_BL_sm_out, ARQ_bird_AR_BL_md_out, ARQ_bird_AR_BL_lg_out, ARQ_bird_SE_BL_sm_out, ARQ_bird_SE_BL_md_out, ARQ_bird_SE_BL_lg_out)
        sum_8_BL = trex_tables.table_sum_8(ARQ_diet_bird_SG_A_BL_out, ARQ_diet_bird_SG_C_BL_out, ARQ_diet_bird_TG_A_BL_out, ARQ_diet_bird_TG_C_BL_out, ARQ_diet_bird_BP_A_BL_out, ARQ_diet_bird_BP_C_BL_out, ARQ_diet_bird_FP_A_BL_out, ARQ_diet_bird_FP_C_BL_out, ARQ_diet_bird_AR_A_BL_out, ARQ_diet_bird_AR_C_BL_out)
        sum_9_BL = trex_tables.table_sum_9(EEC_dose_mamm_SG_sm_BL_out, EEC_dose_mamm_SG_md_BL_out, EEC_dose_mamm_SG_lg_BL_out, EEC_dose_mamm_TG_sm_BL_out, EEC_dose_mamm_TG_md_BL_out, EEC_dose_mamm_TG_lg_BL_out, EEC_dose_mamm_BP_sm_BL_out, EEC_dose_mamm_BP_md_BL_out, EEC_dose_mamm_BP_lg_BL_out, EEC_dose_mamm_FP_sm_BL_out, EEC_dose_mamm_FP_md_BL_out, EEC_dose_mamm_FP_lg_BL_out, EEC_dose_mamm_AR_sm_BL_out, EEC_dose_mamm_AR_md_BL_out, EEC_dose_mamm_AR_lg_BL_out, EEC_dose_mamm_SE_sm_BL_out, EEC_dose_mamm_SE_md_BL_out, EEC_dose_mamm_SE_lg_BL_out)
        sum_10_BL = trex_tables.table_sum_10(ARQ_dose_mamm_SG_sm_BL_out, CRQ_dose_mamm_SG_sm_BL_out, ARQ_dose_mamm_SG_md_BL_out, CRQ_dose_mamm_SG_md_BL_out, ARQ_dose_mamm_SG_lg_BL_out, CRQ_dose_mamm_SG_lg_BL_out, ARQ_dose_mamm_TG_sm_BL_out, CRQ_dose_mamm_TG_sm_BL_out, ARQ_dose_mamm_TG_md_BL_out, CRQ_dose_mamm_TG_md_BL_out, ARQ_dose_mamm_TG_lg_BL_out, CRQ_dose_mamm_TG_lg_BL_out, ARQ_dose_mamm_BP_sm_BL_out, CRQ_dose_mamm_BP_sm_BL_out, ARQ_dose_mamm_BP_md_BL_out, CRQ_dose_mamm_BP_md_BL_out, ARQ_dose_mamm_BP_lg_BL_out, CRQ_dose_mamm_BP_lg_BL_out, ARQ_dose_mamm_FP_sm_BL_out, CRQ_dose_mamm_FP_sm_BL_out, ARQ_dose_mamm_FP_md_BL_out, CRQ_dose_mamm_FP_md_BL_out, ARQ_dose_mamm_FP_lg_BL_out, CRQ_dose_mamm_FP_lg_BL_out, ARQ_dose_mamm_AR_sm_BL_out, CRQ_dose_mamm_AR_sm_BL_out, ARQ_dose_mamm_AR_md_BL_out, CRQ_dose_mamm_AR_md_BL_out, ARQ_dose_mamm_AR_lg_BL_out, CRQ_dose_mamm_AR_lg_BL_out, ARQ_dose_mamm_SE_sm_BL_out, CRQ_dose_mamm_SE_sm_BL_out, ARQ_dose_mamm_SE_md_BL_out, CRQ_dose_mamm_SE_md_BL_out, ARQ_dose_mamm_SE_lg_BL_out, CRQ_dose_mamm_SE_lg_BL_out)
        sum_11_BL = trex_tables.table_sum_11(ARQ_diet_mamm_SG_BL_out, CRQ_diet_mamm_SG_BL_out, ARQ_diet_mamm_TG_BL_out, CRQ_diet_mamm_TG_BL_out, ARQ_diet_mamm_BP_BL_out, CRQ_diet_mamm_BP_BL_out, ARQ_diet_mamm_FP_BL_out, CRQ_diet_mamm_FP_BL_out, ARQ_diet_mamm_AR_BL_out, CRQ_diet_mamm_AR_BL_out)
        sum_15 = trex_tables.table_sum_15(LD50_bl_bird_sm_out, LD50_bl_mamm_sm_out, LD50_bl_bird_md_out, LD50_bl_mamm_md_out, LD50_bl_bird_lg_out, LD50_bl_mamm_lg_out)
...
@require_POST
def trexBatchOutputPage(request):
    thefile = request.FILES['upfile']
    iter_html=loop_html(thefile)
 
    return iter_html, trex_obj_all, jid_batch